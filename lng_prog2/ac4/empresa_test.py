...
def test_05_lista_visitas():
    ...
    assert (emp.listar_visitas()[vend1.email] + emp.listar_visitas()[vend2.email]) == 10, "Numero de visitas incorreto"

if __name__ == "__main__":
    test_prog_cg_invalida()
    test_prog_consulta_cg()
    test_prog_altera_cg()
    test_prog_altera_cg_error()
    test_prog_calcula_salario()
    test_prog_recebe_aumento()
    test_est_cg_invalida()
    test_est_consulta_cg()
    test_est_altera_cg()
    test_est_altera_cg_error()
    test_est_calcula_salario()
    test_est_recebe_aumento()
    test_vend_cg_invalida()
    test_vend_consulta_cg()
    test_vend_altera_cg()
    test_vend_altera_cg_error()
    test_vend_consulta_visitas()
    test_vend_realizar_visitas()
    test_vend_realizar_visitas_error()
    test_vend_zerar_visitas()
    test_vend_calcula_salario01()
    test_vend_calcula_salario02()
    test_vend_recebe_aumento()
    test_01_lista_func_empresa()
    test_02_comeca_func_empresa()
    test_03_inclui_func()
    test_04_folha_pagamento()
    test_05_lista_visitas()
